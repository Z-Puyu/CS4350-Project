...
*/
    ...
    */
        ...
        {
            float r = LeanSmooth.linear(current.r, target.r, moveSpeed);
            float g = LeanSmooth.linear(current.g, target.g, moveSpeed);
            float b = LeanSmooth.linear(current.b, target.b, moveSpeed);
            float a = LeanSmooth.linear(current.a, target.a, moveSpeed);
