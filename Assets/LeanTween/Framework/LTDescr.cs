...
*/
	public class LTDescr
	{
		...
		public override string ToString(){
			return (this.trans!=null ? "name:"+this.trans.gameObject.name : "gameObject:null")+" toggle:"+this.toggle+" passed:"+this.passed+" time:"+this.time+" delay:"+this.delay+" direction:"+this.direction+" from:"+this.from+" to:"+this.to+" diff:"+this.diff+" type:"+this.type+" ease:"+this.easeType+" useEstimatedTime:"+this.useEstimatedTime+" id:"+this.id+" hasInitiliazed:"+this.hasInitiliazed;
		}
		...
		public LTDescr setRotateX(){
			...
			this.initInternal = ()=>{ this.fromInternal.x = this.trans.eulerAngles.x; this.toInternal.x = LeanTween.closestRot( this.fromInternal.x, this.toInternal.x);};
		...
		public LTDescr setRotateY(){
			...
			this.initInternal = ()=>{ this.fromInternal.x = this.trans.eulerAngles.y;  this.toInternal.x = LeanTween.closestRot( this.fromInternal.x, this.toInternal.x);};
		...
		public LTDescr setRotateAround(){
			...
			this.easeInternal = ()=>{
				...
				Vector3 rotateAroundPt = (Vector3)this.trans.TransformPoint( this._optional.point );
				...
				this.trans.localPosition = origPos - diff; // Subtract the amount the object has been shifted over by the rotate, to get it back to it's orginal position
				this.trans.rotation = this._optional.origRotation;

				rotateAroundPt = (Vector3)this.trans.TransformPoint( this._optional.point );
				this.trans.RotateAround(rotateAroundPt, this._optional.axis, LTDescr.val);
		...
		public LTDescr setRotateAroundLocal(){
			...
			this.easeInternal = ()=>{
				...
				LTDescr.val = LTDescr.newVect.x;
				Vector3 origPos = this.trans.localPosition;
				this.trans.RotateAround((Vector3)this.trans.TransformPoint( this._optional.point ), this.trans.TransformDirection(this._optional.axis), -this._optional.lastVal);
				Vector3 diff = origPos - this.trans.localPosition;

				this.trans.localPosition = origPos - diff; // Subtract the amount the object has been shifted over by the rotate, to get it back to it's orginal position
				this.trans.localRotation = this._optional.origRotation;
				Vector3 rotateAroundPt = (Vector3)this.trans.TransformPoint( this._optional.point );
				this.trans.RotateAround(rotateAroundPt, this.trans.TransformDirection(this._optional.axis), LTDescr.val);
		...
		public LTDescr setAlphaVertex(){
			...
			this.easeInternal = ()=>{
				...
				c = new Color( c.r, c.g, c.b, LTDescr.val);
		...
		public LTDescr setCanvasAlpha(){
			...
			this.easeInternal = ()=>{
				...
				LTDescr.val = LTDescr.newVect.x;
				if(this.uiImage!=null){
					Color c = this.uiImage.color; c.a = LTDescr.val; this.uiImage.color = c;
				}else if(this.rawImage!=null){
					Color c = this.rawImage.color; c.a = LTDescr.val; this.rawImage.color = c;
				}
		...
		public LTDescr setCanvasMoveX(){
			...
			this.easeInternal = ()=>{ Vector3 c = this.rectTransform.anchoredPosition3D; this.rectTransform.anchoredPosition3D = new Vector3(this.easeMethod().x, c.y, c.z); };
			return this;
		}
		...
		public LTDescr setCanvasMoveY(){
			...
			this.easeInternal = ()=>{ Vector3 c = this.rectTransform.anchoredPosition3D; this.rectTransform.anchoredPosition3D = new Vector3(c.x, this.easeMethod().x, c.z); };
			return this;
		}
		...
		public LTDescr setCanvasMoveZ(){
			...
			this.easeInternal = ()=>{ Vector3 c = this.rectTransform.anchoredPosition3D; this.rectTransform.anchoredPosition3D = new Vector3(c.x, c.y, this.easeMethod().x); };
			return this;
		}
		...
		public LTDescr setCanvasRotateAround(){
			...
			this.easeInternal = ()=>{
				...
				rect.RotateAround((Vector3)rect.TransformPoint( this._optional.point ), this._optional.axis, -LTDescr.val);
		...
		public LTDescr setCanvasRotateAroundLocal(){
			...
			this.easeInternal = ()=>{
				...
				RectTransform rect = this.rectTransform;
				Vector3 origPos = rect.localPosition;
				rect.RotateAround((Vector3)rect.TransformPoint( this._optional.point ), rect.TransformDirection(this._optional.axis), -LTDescr.val);
				Vector3 diff = origPos - rect.localPosition;
		...
		public LTDescr setCanvasPlaySprite(){
			...
			this.easeInternal = ()=>{
				LTDescr.newVect = this.easeMethod();
				LTDescr.val = LTDescr.newVect.x;
				int frame = (int)Mathf.Round( LTDescr.val );
		...
		private void callback(){ LTDescr.newVect = this.easeMethod(); LTDescr.val = LTDescr.newVect.x; }
		...
		public LTDescr setRotate(){
			...
			this.initInternal = ()=>{ this.from = this.trans.eulerAngles;  this.to = new Vector3(LeanTween.closestRot( this.fromInternal.x, this.toInternal.x), LeanTween.closestRot( this.from.y, this.to.y), LeanTween.closestRot( this.from.z, this.to.z)); };
			this.easeInternal = ()=>{ 
				LTDescr.newVect = this.easeMethod();
		...
		public LTDescr setRotateLocal(){
			...
			this.initInternal = ()=>{ this.from = this.trans.localEulerAngles;  this.to = new Vector3(LeanTween.closestRot( this.fromInternal.x, this.toInternal.x), LeanTween.closestRot( this.from.y, this.to.y), LeanTween.closestRot( this.from.z, this.to.z)); };
			this.easeInternal = ()=>{ 
				LTDescr.newVect = this.easeMethod();
		...
		public LTDescr setGUIMove(){
			...
			this.easeInternal = ()=>{ Vector3 v = this.easeMethod(); this._optional.ltRect.rect = new Rect( v.x, v.y, this._optional.ltRect.rect.width, this._optional.ltRect.rect.height); };
			return this;
		}
		...
		public LTDescr setGUIMoveMargin(){
			...
			this.easeInternal = ()=>{ Vector3 v = this.easeMethod(); this._optional.ltRect.margin = new Vector2(v.x, v.y); };
			return this;
		}
		...
		public LTDescr setGUIScale(){
			...
			this.easeInternal = ()=>{ Vector3 v = this.easeMethod(); this._optional.ltRect.rect = new Rect( this._optional.ltRect.rect.x, this._optional.ltRect.rect.y, v.x, v.y); };
			return this;
		}
		...
		private static void alphaRecursive( Transform transform, float val, bool useRecursion = true){
			...
			if(useRecursion && transform.childCount>0){
				foreach (Transform child in transform) {
					LTDescr.alphaRecursive(child, val);
				}
			}
		}
		...
		private static void alphaRecursive( RectTransform rectTransform, float val, int recursiveLevel = 0){
			if(rectTransform.childCount>0){
				foreach (RectTransform child in rectTransform) {
					...
					LTDescr.alphaRecursive(child, val, recursiveLevel + 1);
				}
			}
		}
	...
	*/
		public LTDescr setEase( LeanTweenType easeType ){
			...
			switch( easeType ){
				case LeanTweenType.linear:
					this.setEaseLinear(); break;
				case LeanTweenType.easeOutQuad:
					this.setEaseOutQuad(); break;
				case LeanTweenType.easeInQuad:
					this.setEaseInQuad(); break;
				case LeanTweenType.easeInOutQuad:
					this.setEaseInOutQuad(); break;
				case LeanTweenType.easeInCubic:
					this.setEaseInCubic();break;
				case LeanTweenType.easeOutCubic:
					this.setEaseOutCubic(); break;
				case LeanTweenType.easeInOutCubic:
					this.setEaseInOutCubic(); break;
				case LeanTweenType.easeInQuart:
					this.setEaseInQuart(); break;
				case LeanTweenType.easeOutQuart:
					this.setEaseOutQuart(); break;
				case LeanTweenType.easeInOutQuart:
					this.setEaseInOutQuart(); break;
				case LeanTweenType.easeInQuint:
					this.setEaseInQuint(); break;
				case LeanTweenType.easeOutQuint:
					this.setEaseOutQuint(); break;
				case LeanTweenType.easeInOutQuint:
					this.setEaseInOutQuint(); break;
				case LeanTweenType.easeInSine:
					this.setEaseInSine(); break;
				case LeanTweenType.easeOutSine:
					this.setEaseOutSine(); break;
				case LeanTweenType.easeInOutSine:
					this.setEaseInOutSine(); break;
				case LeanTweenType.easeInExpo:
					this.setEaseInExpo(); break;
				case LeanTweenType.easeOutExpo:
					this.setEaseOutExpo(); break;
				case LeanTweenType.easeInOutExpo:
					this.setEaseInOutExpo(); break;
				case LeanTweenType.easeInCirc:
					this.setEaseInCirc(); break;
				case LeanTweenType.easeOutCirc:
					this.setEaseOutCirc(); break;
				case LeanTweenType.easeInOutCirc:
					this.setEaseInOutCirc(); break;
				case LeanTweenType.easeInBounce:
					this.setEaseInBounce(); break;
				case LeanTweenType.easeOutBounce:
					this.setEaseOutBounce(); break;
				case LeanTweenType.easeInOutBounce:
					this.setEaseInOutBounce(); break;
				case LeanTweenType.easeInBack:
					this.setEaseInBack(); break;
				case LeanTweenType.easeOutBack:
					this.setEaseOutBack(); break;
				case LeanTweenType.easeInOutBack:
					this.setEaseInOutBack();  break;
				case LeanTweenType.easeInElastic:
					this.setEaseInElastic();  break;
				case LeanTweenType.easeOutElastic:
					this.setEaseOutElastic(); break;
				case LeanTweenType.easeInOutElastic:
					this.setEaseInOutElastic(); break;
				case LeanTweenType.punch:
					this.setEasePunch(); break;
				case LeanTweenType.easeShake:
					this.setEaseShake(); break;
				case LeanTweenType.easeSpring:
					this.setEaseSpring(); break;
				default:
					this.setEaseLinear(); break;
			}
		...
		private Vector3 tweenOnCurve(){
			return	new Vector3(this.from.x + (this.diff.x) * this._optional.animationCurve.Evaluate(this.ratioPassed),
		...
		private Vector3 easeSpring(){
			...
			LTDescr.val = (Mathf.Sin(LTDescr.val * Mathf.PI * (0.2f + 2.5f * LTDescr.val * LTDescr.val * LTDescr.val)) * Mathf.Pow(1f - LTDescr.val, 2.2f ) + LTDescr.val) * (1f + (1.2f * (1f - LTDescr.val) ));
		...
		private Vector3 easeInOutSine(){
			LTDescr.val = -(Mathf.Cos(Mathf.PI * this.ratioPassed) - 1f);
			return new Vector3(this.diffDiv2.x * LTDescr.val + this.from.x, this.diffDiv2.y * LTDescr.val + this.from.y, this.diffDiv2.z * LTDescr.val + this.from.z);
		}
		...
		private Vector3 easeInOutExpo(){
			LTDescr.val = this.ratioPassed * 2f;
			if (LTDescr.val < 1) return this.diffDiv2 * Mathf.Pow(2, 10 * (LTDescr.val - 1)) + this.from;
			LTDescr.val--;
			return this.diffDiv2 * (-Mathf.Pow(2, -10 * LTDescr.val) + 2) + this.from;
		}
		...
		private Vector3 easeInBounce(){
			...
			return new Vector3(this.diff.x - LeanTween.easeOutBounce(0, this.diff.x, LTDescr.val) + this.from.x, 
				this.diff.y - LeanTween.easeOutBounce(0, this.diff.y, LTDescr.val) + this.from.y, 
				this.diff.z - LeanTween.easeOutBounce(0, this.diff.z, LTDescr.val) + this.from.z);
		}
		...
		private Vector3 easeOutBounce ()
		{
			...
			if (LTDescr.val < (valM = 1 - 1.75f * this.overshoot / 2.75f)) {
				LTDescr.val = 1 / valM / valM * LTDescr.val * LTDescr.val;
			} else if (LTDescr.val < (valN = 1 - .75f * this.overshoot / 2.75f)) {
				LTDescr.val -= (valM + valN) / 2;
				// first bounce, height: 1/4
				LTDescr.val = 7.5625f * LTDescr.val * LTDescr.val + 1 - .25f * this.overshoot * this.overshoot;
			} else if (LTDescr.val < (valM = 1 - .25f * this.overshoot / 2.75f)) {
				LTDescr.val -= (valM + valN) / 2;
				// second bounce, height: 1/16
				LTDescr.val = 7.5625f * LTDescr.val * LTDescr.val + 1 - .0625f * this.overshoot * this.overshoot;
			} else { // valN = 1
				LTDescr.val -= (valM + 1) / 2;
				// third bounce, height: 1/64
				LTDescr.val = 7.5625f * LTDescr.val * LTDescr.val + 1 - .015625f * this.overshoot * this.overshoot;
			}
			return this.diff * LTDescr.val + this.from;
		}
		...
		private Vector3 easeInOutBounce(){
			LTDescr.val = this.ratioPassed * 2f;
			if (LTDescr.val < 1f){
				return new Vector3(LeanTween.easeInBounce(0, this.diff.x, LTDescr.val) * 0.5f + this.from.x, 
					LeanTween.easeInBounce(0, this.diff.y, LTDescr.val) * 0.5f + this.from.y, 
					LeanTween.easeInBounce(0, this.diff.z, LTDescr.val) * 0.5f + this.from.z);
			}else {
				LTDescr.val = LTDescr.val - 1f;
				return new Vector3(LeanTween.easeOutBounce(0, this.diff.x, LTDescr.val) * 0.5f + this.diffDiv2.x + this.from.x,
					LeanTween.easeOutBounce(0, this.diff.y, LTDescr.val) * 0.5f + this.diffDiv2.y + this.from.y,
					LeanTween.easeOutBounce(0, this.diff.z, LTDescr.val) * 0.5f + this.diffDiv2.z + this.from.z);
			}
		}
		...
		private Vector3 easeInBack(){
			...
			return this.diff * (LTDescr.val) * LTDescr.val * ((s + 1) * LTDescr.val - s) + this.from;
		}
		...
		private Vector3 easeInOutBack(){
			...
			if ((LTDescr.val) < 1){
				...
				return this.diffDiv2 * (LTDescr.val * LTDescr.val * (((s) + 1) * LTDescr.val - s)) + this.from;
			}
			LTDescr.val -= 2;
			s *= (1.525f) * this.overshoot;
