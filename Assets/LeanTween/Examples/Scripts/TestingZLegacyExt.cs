    ...
    public class TestingZLegacyExt : MonoBehaviour {
        ...
        void cycleThroughExamples()
        {
            if (this.exampleIter == 0)
            {
                ...
                {
                    this.descrTimeScaleChangeId = this.gameObject.LeanValue(0.01f, 10.0f, 3f).setOnUpdate((float val) => {
            ...
            this.gameObject.LeanDelayedCall( delayTime, this.cycleThroughExamples).setUseEstimatedTime(this.useEstimatedTime);
        ...
        public void updateValue3Example()
        {
            ...
            this.gameObject.LeanValue( this.updateValue3ExampleCallback, new Vector3(0.0f, 270.0f, 0.0f), new Vector3(30.0f, 270.0f, 180f), 0.5f).setEase(LeanTweenType.easeInBounce).setRepeat(2).setLoopPingPong().setOnUpdateVector3(this.updateValue3ExampleUpdate).setUseEstimatedTime(this.useEstimatedTime);
        }
        ...
        public void loopTestClamp()
        {
            ...
            cube1.LeanScaleZ( 4.0f, 1.0f).setEase(LeanTweenType.easeOutElastic).setRepeat(7).setLoopClamp().setUseEstimatedTime(this.useEstimatedTime);//
        }
        ...
        public void loopTestPingPong()
        {
            ...
            cube2.LeanScaleY( 4.0f, 1.0f).setEase(LeanTweenType.easeOutQuad).setLoopPingPong(4).setUseEstimatedTime(this.useEstimatedTime);
        ...
        public void colorExample()
        {
            ...
            lChar.LeanColor( new Color(1.0f, 0.0f, 0.0f, 0.5f), 0.5f).setEase(LeanTweenType.easeOutBounce).setRepeat(2).setLoopPingPong().setUseEstimatedTime(this.useEstimatedTime);
        }
        ...
        public void moveOnACurveExample()
        {
            ...
            this.ltLogo.LeanMove( path, 1.0f).setEase(LeanTweenType.easeOutQuad).setOrientToPath(true).setUseEstimatedTime(this.useEstimatedTime);
        }

        public void customTweenExample()
        {
            Debug.Log("customTweenExample starting pos:" + this.ltLogo.position + " origin:" + this.origin);

            this.ltLogo.LeanMoveX(-10.0f, 0.5f).setEase(this.customAnimationCurve).setUseEstimatedTime(this.useEstimatedTime);
        ...
        public void rotateExample()
        {
            ...
            this.ltLogo.LeanRotate(new Vector3(0f, 360f, 0f), 1f).setEase(LeanTweenType.easeOutQuad).setOnComplete(this.rotateFinished).setOnCompleteParam(returnParam).setOnUpdate(this.rotateOnUpdate).setUseEstimatedTime(this.useEstimatedTime);
        }
        ...
        public void scaleExample()
        {
            ...
            Vector3 currentScale = this.ltLogo.localScale;
            this.ltLogo.LeanScale(new Vector3(currentScale.x + 0.2f, currentScale.y + 0.2f, currentScale.z + 0.2f), 1f).setEase(LeanTweenType.easeOutBounce).setUseEstimatedTime(this.useEstimatedTime);
        }
        ...
        public void updateValueExample()
        {
            ...
            pass.Add("message", "hi");
            this.gameObject.LeanValue( (Action<float, object>)this.updateValueExampleCallback, this.ltLogo.eulerAngles.y, 270f, 1f).setEase(LeanTweenType.easeOutElastic).setOnUpdateParam(pass).setUseEstimatedTime(this.useEstimatedTime);
        }
        ...
        public void updateValueExampleCallback(float val, object hash)
        {
            ...
            Vector3 tmp = this.ltLogo.eulerAngles;
            tmp.y = val;
        ...
        public void delayedCallExampleCallback()
        {
            ...
            this.ltLogo.LeanScale( new Vector3(currentScale.x - 0.2f, currentScale.y - 0.2f, currentScale.z - 0.2f), 0.5f).setEase(LeanTweenType.easeInOutCirc).setUseEstimatedTime(this.useEstimatedTime);
        }
        ...
        public void alphaExample()
        {
            ...
            GameObject lChar = GameObject.Find("LCharacter");
            lChar.LeanAlpha( 0.0f, 0.5f).setUseEstimatedTime(this.useEstimatedTime);
            lChar.LeanAlpha( 1.0f, 0.5f).setDelay(0.5f).setUseEstimatedTime(this.useEstimatedTime);
        }
        ...
        public void moveLocalExample()
        {
            ...
            lChar.LeanMoveLocal( new Vector3(0.0f, 2.0f, 0.0f), 0.5f).setUseEstimatedTime(this.useEstimatedTime);
            lChar.LeanMoveLocal( origPos, 0.5f).setDelay(0.5f).setUseEstimatedTime(this.useEstimatedTime);
        }
        ...
        public void rotateAroundExample()
        {
            ...
            GameObject lChar = GameObject.Find("LCharacter");
            lChar.LeanRotateAround(Vector3.up, 360.0f, 1.0f).setUseEstimatedTime(this.useEstimatedTime);
        }
        ...
        {
            this.ltLogo.LeanMoveX(7.0f, 1.0f).setEase(LeanTweenType.punch).setUseEstimatedTime(this.useEstimatedTime);
        }
    }
}
