...
namespace ModularItemsAndInventory.Runtime.Items.Properties
{
    public sealed class Merchandise : ItemProperty
    {
        ...
        [field: SerializeField, OnValueChanged(nameof(UnifyPrices))]
        private bool HasDifferentPriceForSale { get; set; }

        [field: SerializeField, ShowIf(nameof(HasDifferentPriceForSale))]
        public int Worth { get; private set; }
